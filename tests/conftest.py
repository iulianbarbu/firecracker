...
def test_session_root_path():
    """Ensure and return the testrun session root directory exists.

    Create the testrun session root directory to host any other test temporary
    file. If it exists, consider this as a noop.
    """
